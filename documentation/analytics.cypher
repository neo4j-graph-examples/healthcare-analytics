...
RETURN DISTINCT(d.name) as drug, reactions[0..5] as sideEffects, totalReactions ORDER BY totalReactions DESC
LIMIT 5
...
RETURN a.ageGroup as ageGroupName, sideEffects[0..6] as sideEffects ORDER BY total DESC
LIMIT 1
...
RETURN sideEffect, drug ORDER BY sideEffectCount DESC LIMIT 5
...
RETURN drug, reporter, sideEffects[0..5] as sideEffects ORDER BY total desc LIMIT 5;
...
RETURN drug, sideEffects[0..5] as sideEffects, outcome LIMIT 5;
